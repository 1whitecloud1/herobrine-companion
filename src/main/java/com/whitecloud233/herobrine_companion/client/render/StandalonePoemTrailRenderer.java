...
public final class StandalonePoemTrailRenderer extends RenderType {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("herobrine_companion",
    ...
    /**
     * U 轴滚动量（纹理周期）。1.21 没有 {@code Minecraft.getFrameTime()}，这里直接用墙钟时间：
     * 刀光一次只存在 0.2~0.4 秒，帧间增量约 0.011 个纹理周期，float 精度绰绰有余。
     */
    private static float scroll() {
        return System.currentTimeMillis() / 1000f * UV_SPEED;
    }
}
