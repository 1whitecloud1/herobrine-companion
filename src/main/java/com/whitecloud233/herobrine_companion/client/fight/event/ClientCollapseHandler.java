...
import com.whitecloud233.herobrine_companion.world.structure.ModStructures; // 【修复】去掉了错误的 modid 层级
...
public class ClientCollapseHandler {
    ...
    // 【核心演出】：控制音乐停止、心跳声播放
    // =========================================
    // NeoForge 1.21.1 的 TickEvent 变成了明确的 ClientTickEvent.Post
    @SubscribeEvent
    ...
    public static void onRenderGuiPost(RenderGuiEvent.Post event) {
        if (isCollapsing) {
            ...
            if (alpha > 0) {
                ...
                // 1.21.1 推荐直接通过 GuiGraphics 获取屏幕宽高
    ...
    @SubscribeEvent
    public static void onClientLogOut(ClientPlayerNetworkEvent.LoggingOut event) { stopCollapse(); }

    @SubscribeEvent
    public static void onClientLogIn(ClientPlayerNetworkEvent.LoggingIn event) { stopCollapse(); }
}