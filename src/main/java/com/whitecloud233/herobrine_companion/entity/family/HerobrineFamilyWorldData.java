...
public final class HerobrineFamilyWorldData extends SavedData {
    ...
    public static HerobrineFamilyWorldData load(CompoundTag tag, HolderLookup.Provider provider) {
    ...
    public static HerobrineFamilyWorldData get(ServerLevel level) {
        ...
        SavedData.Factory<HerobrineFamilyWorldData> factory =
                new SavedData.Factory<>(HerobrineFamilyWorldData::new, HerobrineFamilyWorldData::load, null);
