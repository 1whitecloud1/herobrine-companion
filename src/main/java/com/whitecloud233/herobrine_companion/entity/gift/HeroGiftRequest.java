...
public final class HeroGiftRequest {
    ...
    /** 递交物是否达成活动请求。 */
    public static boolean matchRequest(com.whitecloud233.herobrine_companion.entity.gift.HeroGiftProfile.ActiveRequest activeRequest, HeroGiftOffer offer) {
    ...
    public static boolean isExpired(com.whitecloud233.herobrine_companion.entity.gift.HeroGiftProfile.ActiveRequest activeRequest, int tick) {
