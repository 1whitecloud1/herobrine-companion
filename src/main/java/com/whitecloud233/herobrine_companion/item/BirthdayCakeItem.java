...
/**
 * 无名之蛋糕 —— Bedrock `herobrine_companion:birthday_cake` 的移植(NeoForge 1.21.1)。
 *
 ...
 * </ul>
 *
 * <p>1.21 适配:`use` 返回 {@link InteractionResult}(1.20.5+ 移除了 InteractionResultHolder);
 * `getUseDuration(ItemStack, LivingEntity)` 两参;tooltip 用 `Item.TooltipContext`。
 */
