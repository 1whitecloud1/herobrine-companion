...
public final class HeroEpicFightBridge {
    ...
    /** Hero 专用的夜幕臂架：标准 biped + 由 {@link HeroNightfallArmatureJoints} 动态补的爪/刺轮关节。 */
    private static final AssetAccessor<HumanoidArmature> HERO_NIGHTFALL_ARMATURE = Armatures.ArmatureAccessor.create(
            HerobrineCompanion.MODID, "entity/hero_biped_nightfall", HumanoidArmature::new
    );
