...
public class HerobrineJeiPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        if (Minecraft.getInstance().level != null) {
            try {
                HeroEntity dummyHero = new HeroEntity(ModEntities.HERO.get(), Minecraft.getInstance().level);
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        // 交易配方催化剂: TAB_ICON
        registration.addRecipeCatalyst(new ItemStack(ModItems.TAB_ICON.get()), HeroTradeCategory.RECIPE_TYPE);
        
        // 奖励配方催化剂: TAB_ICON 和 HERO_SHELTER
        registration.addRecipeCatalyst(new ItemStack(ModItems.TAB_ICON.get()), HeroRewardCategory.RECIPE_TYPE);
        registration.addRecipeCatalyst(new ItemStack(ModItems.HERO_SHELTER.get()), HeroRewardCategory.RECIPE_TYPE);
    }

    private static void registerGhostDropInfo(IRecipeRegistration registration) {
        registration.addItemStackInfo(
                new ItemStack(ModItems.CORRUPTED_CODE.get()),
        ...
        registration.addItemStackInfo(
                new ItemStack(ModItems.VOID_MARROW.get()),
    ...
    private static ItemStack createLoreFragmentStack(String fragmentId) {
        ...
        tag.putString(LoreFragmentItem.LORE_ID_KEY, fragmentId);
    ...
    private static void registerTreasureInfo(IRecipeRegistration registration) {
        registration.addItemStackInfo(
                new ItemStack(ModItems.ETERNAL_KEY.get()),
