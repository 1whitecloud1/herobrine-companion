...
public class HerobrineCompanionKubeJSPlugin extends KubeJSPlugin {
    ...
    public void registerBindings(BindingsEvent event) {
        ...
        event.add("HeroRewards", new HeroRewardsJS());
    }
    ...
    // Minecraft 1.20.1 使用 ItemStack 作为输入，而不是 ItemCost (ItemCost 是 1.21+ 的)
    // 所以这里我们返回 ItemStack
    public static ItemStack parseCost(Object obj) {
    ...
    // --- 事件类 ---
    public static class RegisterRewardsEvent extends EventJS {
    ...
    // [新增] 交易事件类
    public static class HeroTradesEvent extends EventJS {
        ...
        public void add(Object input1, Object input2, Object output, int maxUses, int xp, float priceMult) {
            ...
            if (!costA.isEmpty() && !result.isEmpty()) {
                // 1.20.1 MerchantOffer 构造函数: (ItemStack baseCostA, ItemStack costB, ItemStack result, int maxUses, int xp, float priceMultiplier)
