...
public class HeroTrades {
    ...
    public static MerchantOffers getOffers(HeroEntity hero) {
        ...
        offers.add(new MerchantOffer(
            new ItemStack(ModItems.CORRUPTED_CODE.get(), 4),
        ...
        offers.add(new MerchantOffer(
            new ItemStack(ModItems.VOID_MARROW.get(), 2),
        ...
        if (trust >= 2) {
            offers.add(new MerchantOffer(
                new ItemStack(ModItems.VOID_MARROW.get(), 4),
                new ItemStack(Items.DIAMOND, 1),
                Integer.MAX_VALUE, 5, 0.05f
            ));
            offers.add(new MerchantOffer(
                new ItemStack(ModItems.UNSTABLE_GUNPOWDER.get(), 1),
        ...
        if (trust >= 20) {
            offers.add(new MerchantOffer(
                new ItemStack(ModItems.UNSTABLE_GUNPOWDER.get(), 2),
                new ItemStack(ModItems.GLITCH_FRAGMENT.get(), 1),
                Integer.MAX_VALUE, 10, 0.05f
            ));
            offers.add(new MerchantOffer(
                    new ItemStack(ModItems.SOURCE_CODE_FRAGMENT.get(), 2),
        ...
        if (trust >= 40) {
            offers.add(new MerchantOffer(
                new ItemStack(ModItems.GLITCH_FRAGMENT.get(), 2),
                new ItemStack(Items.DIAMOND_BLOCK, 1),
                Integer.MAX_VALUE, 15, 0.05f
            ));
            offers.add(new MerchantOffer(
                new ItemStack(ModItems.GLITCH_FRAGMENT.get(), 4),
                new ItemStack(Items.NETHERITE_INGOT, 1),
                Integer.MAX_VALUE, 15, 0.05f
            ));
            offers.add(new MerchantOffer(
                    new ItemStack(ModItems.CORRUPTED_CODE.get(), 1),
                    new ItemStack(ModItems.VOID_MARROW.get(), 1),
                    new ItemStack(ModItems.MEMORY_SHARD.get(), 1),
                    Integer.MAX_VALUE, 15, 0.10f
            ));
            offers.add(new MerchantOffer(
                    new ItemStack(ModItems.SOURCE_CODE_FRAGMENT.get(), 1),
        ...
        if (trust >= 70) {
            offers.add(new MerchantOffer(
                new ItemStack(ModItems.UNSTABLE_GUNPOWDER.get(), 4), 
                new ItemStack(ModItems.VOID_MARROW.get(), 4),
