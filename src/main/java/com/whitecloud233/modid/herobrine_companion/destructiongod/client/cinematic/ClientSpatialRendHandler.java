package com.whitecloud233.modid.herobrine_companion.destructiongod.client.cinematic;
    ...
    private static void tickWorldRendCinematic(Minecraft minecraft) {
        ...
        if (worldRendThunderDelay > 0) {
            ...
            if (worldRendThunderDelay == 0 && minecraft.level != null) {
                minecraft.level.playLocalSound(worldRendThunderPos.x, worldRendThunderPos.y, worldRendThunderPos.z, SoundEvents.TRIDENT_THUNDER, SoundSource.WEATHER, 5.0F, 0.62F, false);
