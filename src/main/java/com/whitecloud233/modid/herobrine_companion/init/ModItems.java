...
public class ModItems {
    ...
    // 营养 20 / 饱和极高 / 可随时进食 / 不可堆叠 / uncommon,使用时长 32 tick(见 BirthdayCakeItem)
    public static final RegistryObject<BirthdayCakeItem> BIRTHDAY_CAKE = ITEMS.register("birthday_cake",
