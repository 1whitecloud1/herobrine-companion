...
public final class VoidRiftPostEffect {
    ...
    private static final ResourceLocation CHAIN = new ResourceLocation(
    ...
    private static final class LensChain extends PostChain {
        ...
        @Override
        public PostPass addPass(String name, RenderTarget input, RenderTarget output) throws IOException {
            PostPass pass = super.addPass(name, input, output);
