...
public class ClientChatHandler {
            ...
            if (!trimmed.startsWith("/")) {
                ...
                if (ClientHooks.isApiEnabled()) {
                    ...
                    if (LLMConfig.isSetupIncompleteOrInvalid()) {
                        ...
                        mc.tell(() -> {
                            mc.setScreen(new com.whitecloud233.modid.herobrine_companion.config.ApiKeyInputScreen(new HeroChatScreen("")));
                        });
                        return;
                    }
    ...
    public static void onPlayerLogOut(ClientPlayerNetworkEvent.LoggingOut event) {
        ...
        if (event.getPlayer() != null) {
            ...
            com.whitecloud233.modid.herobrine_companion.client.service.CrossChatHistoryStore.getInstance().saveAndClearSession();
        }
        Minecraft.getInstance().gui.setOverlayMessage(Component.empty(), false);
    }
}