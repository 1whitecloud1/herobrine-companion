...
public class HeroPoseScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(Component.translatable("gui.herobrine_companion.save_pose"), button -> {
            ...
            // 👇 【核心修复】：在客户端立即自我更新！不等待网络回包，消除延迟导致的闪回！
            if (this.minecraft != null && this.minecraft.level != null) {
                // [修改] 变量名改为 targetEntity，防止和最外层的 realEntity 冲突
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (maxScroll > 0) {
            ...
            guiGraphics.fill(barX, viewYStart, barX + barW, viewYEnd, 0x55000000); // 轨道底色
            int thumbColor = isDraggingScrollbar ? 0xFFFFFFFF : 0xFFAAAAAA;
            guiGraphics.fill(barX, thumbY, barX + barW, thumbY + thumbH, thumbColor); // 拖动滑块
        }
        ...
        if (this.dummyHero != null) {
            ...
            InventoryScreen.renderEntityInInventoryFollowsMouse(guiGraphics, centerX, centerY + 90, 75, 0, 0, this.dummyHero);
        }
