...
public final class AgentFrame {
    ...
    public static AgentFrame capture(HeroEntity hero) {
        ...
        net.minecraft.resources.ResourceLocation itemKey = net.minecraftforge.registries.ForgeRegistries.ITEMS.getKey(hero.getMainHandItem().getItem());
    ...
    /** 是否已结伴且同行者在一定范围内（用于"陪伴/看护"意图的粗判）。 */
