    ...
    public static InteractionResult onInteract(HeroEntity hero, Player player, InteractionHand hand) {
        if (hand == InteractionHand.MAIN_HAND) {
            ...
            if (!hero.level().isClientSide) {
                ...
                // 【DEV】赠礼手势测试钩子:潜行 + 手持命名为 "hc_gesture:<1..12>" 的木棍右键英雄,
                // 播放对应 clip(Bedrock offer 控制器 1..12)。Phase B 正式入口接入后移除。
                ...
                if (com.whitecloud233.modid.herobrine_companion.entity.gift.HeroOfferService
