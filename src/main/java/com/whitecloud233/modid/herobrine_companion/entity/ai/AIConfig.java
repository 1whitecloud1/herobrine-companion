...
public class AIConfig {
    ...
    // 修改路径：config/herobrine_companion/herobrine_companion_ai.json
    ...
    public static class ConfigData {
        ...
        public ConfigData() {
            this.aiApiKey = AIConfig.aiApiKey;
            this.aiEndpoint = AIConfig.aiEndpoint;
            this.aiModel = AIConfig.aiModel;
            this.aiSystemPrompt = AIConfig.aiSystemPrompt;
        }
    }

    public static void load() {
        LOGGER.info("Loading AI Config from: {}", CONFIG_FILE.getAbsolutePath());
        if (CONFIG_FILE.exists()) {
            ...
            LOGGER.info("AI Config file not found, creating default.");
            save();
        }
    }

    public static void save() {
        // Ensure parent directory exists (config/herobrine_companion)
        ...
        try (Writer writer = Files.newBufferedWriter(CONFIG_FILE.toPath(), StandardCharsets.UTF_8)) {
            ...
            LOGGER.info("AI Config saved to: {}", CONFIG_FILE.getAbsolutePath());
        } catch (IOException e) {
