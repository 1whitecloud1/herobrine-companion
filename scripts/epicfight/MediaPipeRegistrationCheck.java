...
public class MediaPipeRegistrationCheck {
    ...
    public static void main(String[] args) throws Exception {
        // Forge's StaticAnimation constructor hashes its resource immediately.
        // Supply the actual project assets without starting the Forge ModList.
        try (var resources = new MultiPackResourceManager(PackType.CLIENT_RESOURCES,
                List.of(new PathPackResources("scythe-verifier", Path.of("src/main/resources"), false)))) {
    ...
    private static void verify() throws Exception {
        ...
        // Trail/sound factories require a full Forge bootstrap and are deferred.
        ...
        var createPhases = MediaPipeScytheAnimations.class.getDeclaredMethod("phases",
                timings.get(0).getClass(), float.class, AssetAccessor.class);
        ...
        var playerAccessor = (AnimationManager.AnimationAccessor<? extends yesman.epicfight.api.animation.types.BasicAttackAnimation>)
        ...
        if (!Float.valueOf(4F).equals(field(PoemScythePlayerAnimations.class, "COMBO_SPEED"))
                || !Float.valueOf(4F / 3F).equals(field(PoemScythePlayerAnimations.class, "SPECIAL_SPEED"))) {
